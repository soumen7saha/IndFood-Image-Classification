...
## Dataset Description
The dataset consists of around 135,335 images and 131 food items (classes). The images of food items belong to different food categories: sweet, curry, snacks, bread, cereal, beverage, pizza and kebab. The whole dataset is constructed from the two resources and split into train & val in an 85%-15% proportion. It can be accessed from the this [link](https://github.com/soumen7saha/IndFood-Dataset).
